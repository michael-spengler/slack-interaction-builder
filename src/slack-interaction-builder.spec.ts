...
test('basic slack attachment', () => {
    ...
    expect(attachment.text).toBe("Hello Attachment");
...
test('basic slack action', () => {
    ...
    expect(action.text).toBe("Hello Action");
});
...
test('basic message with action and attachment', () => {
    ...
    expect(message.attachments[0].actions[0].text).toEqual("Hello Action 1");
    expect(message.attachments[0].actions[1].text).toEqual("Hello Action 2");
});